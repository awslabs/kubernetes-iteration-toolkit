...
import (
	...
	"github.com/awslabs/kubernetes-iteration-toolkit/substrate/pkg/controller/substrate/cluster/addons"
	"github.com/awslabs/kubernetes-iteration-toolkit/substrate/pkg/controller/substrate/infrastructure"
...
func NewController(ctx context.Context) *Controller {
	...
	return &Controller{
		Resources: []Resource{
			...
			&cluster.Config{S3: s3.New(session), STS: sts.New(session), S3Uploader: s3manager.NewUploader(session),EC2:EC2},
			&cluster.Readiness{},
