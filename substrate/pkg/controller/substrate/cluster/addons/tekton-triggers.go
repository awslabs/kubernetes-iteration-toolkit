...
metadata:
  ...
  labels:
    app.kubernetes.io/instance: default
    app.kubernetes.io/part-of: tekton-triggers
    triggers.tekton.dev/release: "v0.19.0"
    version: "v0.19.0"
spec:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: tekton-triggers-controller
          image: "gcr.io/tekton-releases/github.com/tektoncd/triggers/cmd/controller:v0.19.0@sha256:95ccd46631cabc517d7e1f870d4dd3062cb241128e79564c23dca2fb6003ef62"
          args: ["-logtostderr", "-stderrthreshold", "INFO", "-el-image", "gcr.io/tekton-releases/github.com/tektoncd/triggers/cmd/eventlistenersink:v0.19.0@sha256:4d1e4e013bc5b0ab9259550c5d165130d141130db1048b0804a0524bf1d284f3", "-el-port", "8080", "-el-security-context=true", "-el-events", "disable", "-el-readtimeout", "5", "-el-writetimeout", "40", "-el-idletimeout", "120", "-el-timeouthandler", "30", "-el-httpclient-readtimeout", "30", "-el-httpclient-keep-alive", "30", "-el-httpclient-tlshandshaketimeout", "10", "-el-httpclient-responseheadertimeout", "10", "-el-httpclient-expectcontinuetimeout", "1", "-period-seconds", "10", "-failure-threshold", "1"]
          env:
    ...
    spec:
      ...
      containers:
        - name: webhook
          ...
          image: "gcr.io/tekton-releases/github.com/tektoncd/triggers/cmd/webhook:v0.19.0@sha256:a397556747ae69528206cc932ce9799d86928622e94d54244701fb10ddc5de99"
          env:
            - name: SYSTEM_NAMESPACE
              valueFrom:
                fieldRef:
